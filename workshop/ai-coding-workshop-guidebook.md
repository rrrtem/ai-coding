...
**2. Node.js 20+ — среда для JavaScript**
...
|---|---------|--------------------|----|
| 1 | `node -v` | `v20.x.x` или выше | ☐ |
| 2 | `npm -v` | `10.x.x` или выше | ☐ |
...
**Установка:** GitHub → [superpowers repository link] → Follow installation instructions in Conductor Extensions.
...
AI пишет код быстро — но не думает о безопасности. Claude Code не будет сам проверять, не утекли ли ваши API-ключи или не открыта ли база данных для всего интернета. Одна ошибка может привести к утечке данных всех ваших пользователей.

Хорошая новость: большинство атак используют одни и те же простые уязвимости. Настройка из этого раздела занимает **10 минут**, но закрывает **90% типичных атак**.
